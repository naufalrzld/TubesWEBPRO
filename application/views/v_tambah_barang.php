<div class="container">
		<div class="register">
			...
			<form action="<?php echo site_url("kelola_toko/buat_barang")?>" method="post" enctype="multipart/form-data">
				...
				<div class="row form-register">
					<div class="col-sm-12">
						<input type="text" class="form-control" aria-describedby="inputGroup-sizing-default" placeholder="Informasi Barang" name="informasi" required>
					</div>
				</div>
				<div class="row form-register">
					<div class="col-sm-12">
						<textarea rows="4" cols="50" class="form-control" aria-describedby="inputGroup-sizing-default" placeholder="Spesifikasi Barang" name="spec" required></textarea>
					</div>
				</div>
				<div class="row form-register">
					<div class="col-sm-12">
				...
				<div class="row form-register">
					<div class="col-sm-12">
						<textarea rows="4" cols="50" class="form-control" aria-describedby="inputGroup-sizing-default" placeholder="Catatan" name="catatan" required></textarea>
					</div>
				</div>
				<div class="row form-register">
					<div class="col-sm-12">
